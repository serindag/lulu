                ...
                @foreach ($categories as $category)
                    <li class="dd-item dd3-item" data-id="{{ $category->id }}">
                        ...
                        <div class="dd3-content">{{ $category->name }}
                            ...
                            <span style="float:right;margin-left:5px">
                                <a href="{{ route('admin.category.saveform', $category->id) }}"
                                    class="button"><i class="fa-solid fa-pen-to-square"></i></a>
                            </span>
                            <span style="float:right;margin-left:5px">
                                <a href="{{ route('admin.product.list', $category->id) }}" class="button"><i
                                ...
                                @foreach ($category->children as $child)
                                    <li class="dd-item dd3-item" data-id="{{ $child->id }}">
                                        ...
                                        <div class="dd3-content">{{ $child->name }}
                                            ...
                                            <span style="float:right;margin-left:5px">
                                                <a href="{{ route('admin.category.saveform', $child->id) }}"
                                                    class="button"><i class="fa-solid fa-pen-to-square"></i></a>
                                            </span>
                                            <span style="float:right;margin-left:5px">
                                                <a href="{{ route('admin.product.list', $child->id) }}"
                                    ...
                                    @foreach ($child->children as $subchild)
                                        <li class="dd-item dd3-item" data-id="{{ $subchild->id }}">
                                            ...
                                            <div class="dd3-content">{{ $subchild->name }}
                                                ...
                                                <span style="float:right;margin-left:5px">
                                                    <a href="{{ route('admin.category.saveform', $subchild->id) }}"
                                                        class="button"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                </span>
                                                <span style="float:right;margin-left:5px">
                                                    <a href="{{ route('admin.product.list', $subchild->id) }}"
                                                        class="button"><i
                                                            class="fa-solid fa-martini-glass"></i></a>
                                                </span>
                                                <span style="float:right;margin-left:5px">
    ...
    @push('js')
        ...
        <script>
            $(".status").click(function() {
                ...
                $.get("{{ route('admin.category.status') }}", {
                    id: id
        ...
        <script>
            $(".deletebutton").click(function() {
                ...
                if (confirm("Silinsin mi?") == true) {
                    ...
                    $.get("{{ isset($category) ? route('admin.category.delete', $category->id) : '' }}",
                        function(data, status) {
                            alert(data);
                            location.reload();
