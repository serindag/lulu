...
class ProductController extends Controller
{
    public function list($id = null)
    {
        ...
        return view('branch.pages.product.list', compact('products', 'category'));
    }
    ...
    public function saveform($category = null, $id = null)
    {
        ...
        return view('branch.pages.product.form', compact('langs', 'langFirst', 'productLangs', 'product', 'categories', 'branches', 'category'));
    }
